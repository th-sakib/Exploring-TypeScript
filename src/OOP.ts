{
    ...
    class Orbit2 {
        ...
        constructor(public name:string, public motion: string) {// if used public inside the constructor no need to initialize them the ts will automatically initialize and assign them 
            // this.name = name,
            // this.motion = motion 
        }
    }
